...
if(!stepNames.contains(runStepName)){
  ...
  final public void pairID() throws ParseException {Token id1Tok;
    Token id2Tok;
    string id1;
    string id2;
...
//COnd 8
  ...
  final public String Cond() throws ParseException {Token condIDTok;
    String condID;
    Token numTok;
    int numeral;
    String output="";
